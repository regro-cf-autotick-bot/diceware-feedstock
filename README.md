...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/diceware-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10832&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/diceware-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `diceware` can be installed with:

```
conda install diceware
```

It is possible to list all of the versions of `diceware` available on your platform with:
